...
// sensible fallbacks. Per-tenant lookup (by domain) is the multi-tenant step — see the Yardhand Handbook (Part D).
export default async function Page() {
  ...
  const description = (biz && biz.seoDescription && biz.seoDescription.trim()) ||
    `Dump trailer rental in ${cityFull}. Roofing, remodel, demolition, renovation cleanouts, or landscaping haul-off — book online, delivery or will-call, no CDL needed.`;
